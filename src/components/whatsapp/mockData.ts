...
export const mockConversations: Conversation[] = [
  { id: '1', name: 'Paciente João', phone: '5511999999999', lastMessage: 'Confirmo sim', lastMessageTime: '10:32', unread: 2, avatarInitial: 'J', isOnline: true, status: 'attending' },
  { id: '2', name: 'Maria Silva', phone: '5511888888888', lastMessage: 'Qual o horário?', lastMessageTime: '09:45', unread: 0, avatarInitial: 'M', isOnline: false, status: 'all' },
  { id: '3', name: 'Carlos Souza', phone: '5511777777777', lastMessage: 'Obrigado pelo atendimento!', lastMessageTime: 'Ontem', unread: 1, avatarInitial: 'C', isOnline: true, status: 'attending' },
  { id: '4', name: 'Ana Paula', phone: '5511666666666', lastMessage: 'Vou confirmar amanhã', lastMessageTime: 'Ontem', unread: 0, avatarInitial: 'A', isOnline: false, status: 'all' },
  { id: '5', name: 'Roberto Lima', phone: '5511555555555', lastMessage: 'Pode me enviar o contrato?', lastMessageTime: 'Seg', unread: 3, avatarInitial: 'R', isOnline: false, status: 'unread' },
];
...
export const mockMessages: Record<string, ChatMessage[]> = {
  ...
  '3': [
    ...
    { id: '3', type: 'received', text: 'Obrigado pelo atendimento!', time: '14:05' },
  ],
  '4': [
